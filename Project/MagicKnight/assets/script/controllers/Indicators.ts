...
import { HPChangeEvent } from 'db://assets/script/events/HPChangeEvent';
...
class IndicatorController {
    ...
    indicator: cc.Node
    uiComponent: cc.UITransformComponent
    originalSize: cc.math.Size

    constructor(indicator: cc.Node) {
        this.indicator = indicator
        this.uiComponent = this.indicator.getComponent(cc.UITransformComponent)
    ...
    updateValue(value: number) {
        ...
        this.uiComponent.setContentSize(new cc.math.Size(newX, oldY))
    }
}

@ccclass('Indicators')
export class Indicators extends cc.Component {
    // [1]
    // dummy = '';
    ...
    start () {
        ...
        this.onHpChangeEventId = EventManager.instance.on("hp-change", (event: HPChangeEvent) =>
            this.hpIndicator.updateValue(event.hp)
        )
    }
